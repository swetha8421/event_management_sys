...
<body>
	...
	<div class="containerBox">
			...
			<table border=1 class="userTable">
				...
				<tbody>
					<tr>
						...
						<td>
							<img src="OrgImageServlet?id=<%= session.getAttribute("organizer_id") %>"
		...
		<div class="btnDiv">
			<div class="eventBtn">
				<a href="DropdownServlet">Add Event</a>
			</div>
			...
			<div class="eventBtn">
				<a href="ViewOrganizerFeedbackServlet?organizerId=<%= session.getAttribute("organizer_id") %>">View Feedbacks</a>
			</div>
		</div>
		</div>
		</div>
