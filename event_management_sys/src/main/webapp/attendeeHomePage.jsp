	...
	<div class="containerBox">
		...
		<div class="mainContainer">
			...
			<table border=1 class="userTable">
				...
				<tbody>
					<tr>
						...
						<td>
								<img src="AttendeeImageServlet?id=<%= session.getAttribute("attendee_id") %>"
			...
			<div class="addEventBtn">
				<a href="ViewAttendeeEventServlet?attendeeId=<%=session.getAttribute("attendee_id")%>">View Event</a>
			</div>
			
			
			<div class="addEventBtn">
				<a href="ViewFeedbackServlet?attendeeId=<%=session.getAttribute("attendee_id")%>">View Feedbacks</a>
			</div>
			</div>
