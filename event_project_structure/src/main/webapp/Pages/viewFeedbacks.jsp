			...
			<ul>
				...
				<li>
					<div class="filterSearchBox">
    					<form action="${pageContext.request.contextPath}/FilterFeedbackServlet" method="get">
        			...
        			<button href="Pages/viewFeedbacks.jsp">Clear</button>
    				</form>
				</div>
				</li>
