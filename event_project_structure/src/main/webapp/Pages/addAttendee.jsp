...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/addAttendeeStyle.css?v=2">
...
<body>
	...
	<div class="containerBox">
		...
		<form action="${pageContext.request.contextPath}/AddAttendeeServlet" method="post" class="formContainer">	
		<div class="fields">
